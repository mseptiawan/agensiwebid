    ...
    <nav className="">
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    isActive
                      ...
                      : "px-3 py-2 rounded-md text-lg  duration-75 font-semibold font-outline-4  text-semibold "
                  }
                >
                  Beranda
                </NavLink>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 ml-5 font-inter pt-2 pb-3 space-y-1 sm:px-3 bg-[#0a0422b6]  mx-4 border rounded-lg border-[#0a0422b6] ">
            <NavLink
              to="/jasa-pembuatan-website"
              className={({ isActive }) =>
                isActive
                  ? "block px-3 py-2 rounded-md text-base font-medium bg-[#004AAD] "
