    ...
    emailjs
      ...
      .then(
        (result) => {
          ...
          toast.success("Terima kasih, saya telah membalas email anda.");
          setEmail("");
        },
        (error) => {
          ...
          <div className="grid grid-cols-12 gap-8 py-14 lg:grid-cols-8">
            <div className="mb-0 col-span-full lg:col-span-3 ">
              <a href="#" className="flex justify-center lg:justify-start">
                <img src={consultan} alt="logo"  className="w-52 -mt-2 -ml-2    " />
              </a>
              <p className=" text-center  lg:text-left  w-5/6 mx-auto ss:w-1/2 xs:w-5/6 mb-8 lg:w-full">
                Penyedia jasa pembuatan website dimulai web portofolio, landing
                page, company profile, hingga blog. dengan menjadi mitra anda
                ayo kita menuju kesuksesan bersama.
              </p>
              <div className="flex mt-4 space-x-4 justify-center lg:justify-start sm:mt-0 ">
                <a
                  href="https://instagram.com/MyConsultanIT"
                ...
                <a
                  href="https://x.com/MyConsultanIT"
                ...
                <a
                  href="https://www.youtube.com/@mseptiawan-r"
                ...
                >
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M12 2C12.5 6.75 15.25 9.5 20 10V12C18.5 12 16.75 11.5 15.5 10.75V16C15.5 19.25 12.75 22 9.5 22C6.25 22 4 19.25 4 16C4 12.75 6.25 10 9.5 10C9.75 10 10 10 10.25 10.25V12.5C10 12.5 9.75 12.5 9.5 12.5C8 12.5 7 13.75 7 15C7 16.25 8 17.5 9.5 17.5C11 17.5 12 16.25 12 15V2Z"
                      fill="white"
                    />
                  </svg>
                </a>
            ...
            <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
              ...
              <ul className=" transition-all duration-500">
                ...
                <li>Sukamaju, Palembang, Indonesia.</li>
              </ul>
            </div>
            <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:order-last sm:col-span-4 md:col-span-4 lg:order-none lg:col-span-1">
              <h4 className="text-lg font-medium mb-7">Quicklinks</h4>
              <ul className=" transition-all duration-500  ">
                <li className="mb-6">
                ...
                <li className="mb-6">
                  <a href="/portofolio" className="  hover:">
                    Portofolio
                  </a>
                </li>
                <li className="sm:mb-6">
                  <a href="/kontak" className="  hover:">
                    kontak
                  </a>
                </li>
              </ul>
            ...
            <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
              <h4 className="text-lg text-center  font-medium mb-7 lg:text-left">
                Newsletter
              </h4>
              <div className="flex flex-col items-center lg:items-start">
                <form action="" onSubmit={handleSubmit}>
                  ...
                  <button
                    type="submit"
                    className="h-11 bg-white font-bold text-black shadow-2xl  py-3 px-6 rounded-full text-sm   w-fit hover:scale-95 duration-100"
                  >
                    Subscribe
                  </button>
                </form>
          ...
          <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              <span className="text-sm  ">
                ©<a href="https://pagedone.io/">MyConsultanIT</a> 2024, All
                rights reserved.
              </span>
            </div>
          </div>
